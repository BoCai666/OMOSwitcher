...
import { Search, Close, InfoFilled, Refresh, Plus, Edit } from '@element-plus/icons-vue'
...
const editingProvider = ref<ProviderWithAvailability | null>(null)
...
// 打开编辑对话框
function openEditProvider(provider: ProviderWithAvailability) {
...
<template>
  <div class="model-manage" v-loading="loading" element-loading-text="加载模型注册表...">
    ...
    <div class="page-header">
      ...
      <div class="header-right">
        <el-input
          ...
          class="search-input"
        />
        <el-button @click="addProviderVisible = true" type="primary" plain>
      ...
      <div v-if="selectedProvider" class="model-panel">
        <div class="panel-header">
          <div class="panel-title-row">
            ...
            <el-button text class="panel-close-btn" @click="selectedProvider = null">
    ...
    <!-- 编辑自定义供应商对话框 -->
    <EditProviderDialog
      v-model:visible="editProviderVisible"
